package mizdacollinz.rss_top10;
...
//            Log.d(TAG, "onPostExecute: parameter is " + s);
            ...
            //Process the parsed application information
        ...
        private String downloadXML(String urlInput){
            ...
            try {
                ...
                //Read characters into xmlResult until no more queued content
                int charsRead;
                ...
                br.close();
                return xmlResult.toString(); //Retrieve compiled string from builder
